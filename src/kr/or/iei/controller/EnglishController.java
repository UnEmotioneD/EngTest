...
public class EnglishController implements EnglishInterface {
    ...
    public EnglishController() {
        ...
        continueSearchList = new ArrayList<WordWithIndex>();
        wordsWithIndex = new ArrayList<WordWithIndex>();
        ...
        while (!found) {
            ...
            switch (searchWord.length()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    chosenIndex = view.searchView(threeChar(searchWord.charAt(0), searchWord.charAt(1), searchWord.charAt(2)));
                    break;
                default:
                    for (Word word : list) {
    ...
    public void test() {
        ...
        for (int i = 0; i < ranNum; i++) {
            if (selWord.equals("e")) {
                ...
                if (!answer.equals(list.get(ran[i]).getDef1()) || !answer.equals(list.get(ran[i]).getDef2())) {
                    testList.add(list.get(ran[i]));
                }
            } else {
